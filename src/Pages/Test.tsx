      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <section className="flex flex-col justify-center items-center mb-6">
          <div className="flex w-full justify-between items-center rounded-xl space-x-4">
            <ButtonCard
              ...
              link="https://discord.gg/8FsjyrgGUe"
            />
          </div>
        </section>
        ...
        <section className="flex flex-col justify-center items-center mb-6">
          <div className="w-full max-w-3xl">
            <iframe
               src="https://player.twitch.tv/?channel=marshalada&parent=marshalada.com&autoplay=true"
              height="400"
              width="100%"
              allowFullScreen
               className="rounded-lg shadow-lg border-2 border-yellow-500"
            ></iframe>
          </div>
        </section>
        ...
        <section className="bg-gray-800 rounded-xl p-6 shadow-md mb-6">
          ...
          <div className="w-full">
            <ChatEmbed
              server="1209452649293021257"
              channel="1209452649293021260"
              title="Anuncios"
            />
          </div>
        </section>
